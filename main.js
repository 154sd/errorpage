  ...
  (() => {
      ...
      constructor(t, i, e) {
        if ("number" != typeof t && t) {
          ...
          if (void 0 === t || void 0 === i)
            throw new Error("Testball - Vector3d 未正确初始化");
    ...
    class K {
      ...
      async nextFrame(t) {
        ...
        try {
          ...
          console.error("Testball循环加载错误", t);
        }
      }
    }
    class tt {
        ...
        const o =
          ...
          h = l
            ? await (async function (t, i) {
                ...
                console.error(`Testball - 在检索配置文件 ${s.status} 时错误`);
              })(r, n)
            : t.options;
        let c =
    ...
    const _i = new (class {
      ...
      setOnClickHandler(t) {
        ...
        if (!i.length)
          throw new Error(
            "只能在调用 Testball.load() 或 Testball.loadJSON() 后设置点击处理程序"
          );
